        ...
        <form action="edit-product" method="post" class="border p-5" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="7" placeholder="Mô tả...">${product.description}</textarea>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <c:if test="${not empty product.img}">
                        <div class="mt-2">
                            <label class="form-label style_18"><b>Ảnh hiện tại</b></label>
                            <img src="${pageContext.request.contextPath}${product.img}" alt="Current Image" style="max-width: 100px; max-height: 100px;" />
                        </div>
                    </c:if>
                </div>
            </div>

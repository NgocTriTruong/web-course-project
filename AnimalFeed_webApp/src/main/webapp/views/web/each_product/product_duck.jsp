            ...
            <div class="row justify-content-center mb-3 pt-3">
                <div class="col-md-3">
                    <select id="group" class="form-select" style="height: 50px; font-size: 20px;">
                        ...
                        <option value="Vịt thịt">Thức ăn cho vịt thịt</option>
                        <option value="Vịt trứng">Thức ăn cho vịt trứng</option>
                    </select>
                </div>
                <div class="col-md-3">
        ...
        <div class="container mt-5">
            ...
            <div class="p mt-4" style="text-indent: 30px;">
                ...
                <div class="mt-1" style="text-indent: 30px;">
                    <span class="fw-bold" style="text-indent: 30px;">Vinafeed Group</span> luôn cung cấp những giải pháp tốt nhất hỗ trợ người chăn nuôi trong từng giai đoạn. Đặc biệt, những giải pháp thông qua thức ăn XANH - SẠCH sẽ đảm bảo trại vịt của người chăn nuôi đạt được kết quả toàn diện nhất.
                </div>
            </div>
            <div class="p mt-3 fw-bold" style="font-size: 22px;">Thức ăn chăn nuôi dành cho vịt qua từng giai đoạn</div>
            <div id="more_text_product" class="more_text_product">
                <div class="p mt-2" style="text-indent: 30px;">
                    Hiểu rõ được nhu cầu dinh dưỡng thiết yếu cho từng giai đoạn sinh trưởng của vịt, Vinafeed Group đã nghiên cứu, phát triển và sản xuất các dòng thức ăn chăn nuôi vịt riêng biệt cho từng giai đoạn:
                    <p style="text-indent: 50px;">
                        - Thức ăn cho vịt thịt.
                    </p>
                    <p style="text-indent: 50px;">
                        - Thức ăn cho vịt trứng.
                    </p>
                </div>
                ...
                <div class="p mt-2" style="text-indent: 30px;">
                    Thông qua những yêu cầu hỗ trợ mỗi ngày của người chăn nuôi, Vinafeed Group mỗi ngày đều nhận và giải đáp cho hàng nghìn chủ trang trại vịt gửi
                ...
                <div class="p mt-2" style="text-indent: 30px;">
                    ...
                    cung cấp đến người chăn nuôi vịt. Hơn thế, mạng lưới vận chuyển và cung cấp sản phẩm rộng khắp toàn quốc hoàn toàn đáp ứng được nhu cầu của từng người chăn nuôi mọi miền đất nước.
                    <p style="text-indent: 30px;">

    ...
    <div class="row justify-content-center mb-3 pt-3">
      <div class="col-md-3">
        <select id="group" class="form-select" style="height: 50px; font-size: 20px;">
          ...
          <option value="Vịt thịt">Thức ăn cho cá ba sa</option>
          <option value="Vịt trứng">Thức ăn cho cá điêu hồng</option>
          <option value="Tổng hợp">Thức ăn cho cá cá lóc</option>
          <option value="Tổng hợp">Thức ăn cho cá trắm chép</option>
          <option value="Tổng hợp">Thức ăn cho cá rô đồng</option>
          <option value="Vịt trứng">Thức ăn cho cá sặc rằn</option>
          <option value="Tổng hợp">Thức ăn cho cá cá trê vàng</option>
          <option value="Tổng hợp">Thức ăn cho cá chẽm</option>
          <option value="Tổng hợp">Thức ăn cho cá kèo</option>
        </select>
      </div>
      <div class="col-md-3">
  ...
  <div class="container mt-5">
    ...
    <div class="p mt-4" style="text-indent: 30px;">
      ...
      <div class="mt-1" style="text-indent: 30px;">
        <span class="fw-bold" style="text-indent: 30px;">Vinafeed Group</span> luôn cung cấp những giải pháp tốt nhất hỗ trợ người chăn nuôi trong từng giai đoạn. Đặc biệt, những giải pháp thông qua thức ăn XANH - SẠCH sẽ đảm bảo trại cá của người chăn nuôi đạt được kết quả toàn diện nhất.
      </div>

    </div>
    <div class="p mt-3 fw-bold" style="font-size: 22px;">Thức ăn chăn nuôi dành cho cá qua từng giai đoạn</div>
    <div id="more_text_product" class="more_text_product">
      <div class="p mt-2" style="text-indent: 30px;">
        Hiểu rõ được nhu cầu dinh dưỡng thiết yếu cho từng giai đoạn sinh trưởng của cá, Vinafeed Group đã nghiên cứu, phát triển và sản xuất các dòng thức ăn chăn nuôi cá riêng biệt cho từng giai đoạn:
        <p style="text-indent: 50px;">
          - Thức ăn cho cá ba sa.
        </p>
        <p style="text-indent: 50px;">
          - Thức ăn cho cá điêu hồng.
        </p>
        <p style="text-indent: 50px;">
          - Thức ăn cho cá cá lóc.
        </p>
        <p style="text-indent: 50px;">
          - Thức ăn cho cá sặc rằn.
        </p>
        <p style="text-indent: 50px;">
          - Thức ăn cho cá cá trê vàng.
        </p>
        <p style="text-indent: 50px;">
          - Thức ăn cho cá chẽm.
        </p>
        ...
        <p style="text-indent: 50px;">
          - Thức ăn cho cá trắm chép.
        </p>
        <p style="text-indent: 50px;">
          - Thức ăn cho cá rô đồng.
        </p>
        <p tyle="text-indent: 30px;">
          Mỗi giai đoạn cá sẽ được xây dựng một khẩu phần thức ăn phù hợp. Tất cả nguồn nguyên liệu đầu vào đều có nguồn gốc truy xuất rõ ràng, xanh sạch tốt cho gia súc. Từ đó mang đến những sản phẩm chất lượng cao cùng sự đảm bảo hiệu suất chăn nuôi bền vững cho trang trại.
        </p>
        <p tyle="text-indent: 30px;">
          Thức ăn chăn nuôi cá của Vinafeed Group cung cấp cho vật nuôi dinh dưỡng hoàn chỉnh từ nhiều loại nguyên liệu thô như đậu nành, bắp… Cùng những vi chất dinh dưỡng chính như các khoáng chất, vitamin…
        </p>
      </div>
      ...
      <div class="p mt-2" style="text-indent: 30px;">
        Thông qua những yêu cầu hỗ trợ mỗi ngày của người chăn nuôi, Vinafeed Group mỗi ngày đều nhận và giải đáp cho hàng nghìn chủ trang trại cá gửi

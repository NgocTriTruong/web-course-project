            ...
            <div class="container d-flex content_top">
                ...
                <div class="text_right mt-4">
                    <div class="button" style="background-color: #fcac18bc;">
                        <a href="${pageContext.request.contextPath}/views/web/he_thong_cua_hang.html">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-2 text-left">
                        ...
                        <a href="${pageContext.request.contextPath}/views/web/each_product/product_pig.html">
                            <div class="p mt-3">Thức ăn cho Heo</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/each_product/product_chicken.html">
                            <div class="p mt-3">Thức ăn cho Gà</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/each_product/product_duck.html">
                            <div class="p mt-3">Thức ăn cho Vịt</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/each_product/product_cow.html">
                            <div class="p mt-3">Thức ăn cho Bò</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/each_product/product_shirmp.html">
                            <div class="p mt-3">Thức ăn cho Tôm</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/each_product/product_fish.html">
                            <div class="p mt-3">Thức ăn cho Cá</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/each_product/product_goat.html">
                            <div class="p mt-3">Thức ăn cho Dê</div>
                        </a>
                    </div>
                    <div class="col-md-2">
                        <div class="h4 text-light text-left">VỀ VINAFEED</div>
                        <a href="${pageContext.request.contextPath}/views/web/gioi_thieu.html#gioi_thieu_chung">
                            <div class="p mt-3">Giới thiệu chung</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/gioi_thieu.html#lich_su">
                            <div class="p mt-3">Lịch sử hình thành</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/gioi_thieu.html#chien_luoc">
                            <div class="p mt-3">Tầm nhìn chiến lược</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/gioi_thieu.html#quan_diem">
                            <div class="p mt-3">Quan điểm kinh doanh</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/gioi_thieu.html#cam_ket">
                            <div class="p mt-3">Cam kết chất lượng</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/gioi_thieu.html#nhan_luc">
                            <div class="p mt-3">Nguồn nhân lực</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/gioi_thieu.html#van_hoa">
                            <div class="p mt-3">Văn hóa công ty</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/gioi_thieu.html#thanh_tich">
                            <div class="p mt-3">Thành tích</div>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <div class="h4 text-light">THÔNG TIN THÊM</div>
                        <a href="${pageContext.request.contextPath}/views/web/tu_van.html">
                            <div class="p mt-3">Tư vấn kỹ thuật</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/tin_tuc/tin_tuc.html">
                            <div class="p mt-3">Tin tức</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/thu_vien.html">
                            <div class="p mt-3">Thư viện</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/doi_tac.html">
                            <div class="p mt-3">Đối tác</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/chinh_sach_bao_mat.html">
                            <div class="p mt-3">Chính sách bảo mật</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/chinh_sach_mua_hang.html">
                            <div class="p mt-3">Hướng dẫn mua hàng & thanh toán online</div>
                        </a>
                        <a href="${pageContext.request.contextPath}/views/web/ho_tro.html">

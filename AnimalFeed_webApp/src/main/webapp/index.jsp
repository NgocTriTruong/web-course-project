...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/views/template/assets/css/home.css">
  ...
  <div class="list-images">
    <div>
      <video class="w-100" controls autoplay muted>
        <source src="${pageContext.request.contextPath}/views/template/assets/images/banner/Home_video_con_heo_1920x1000.mp4" type="video/mp4">
      </video>
    </div>
    <div>
      <p class="slide_in_para fw-bold text-start">Tập đoàn thức ăn chăn nuôi hàng đầu Việt Nam với chất lượng quốc tế</p>
      <img class="w-100" src="${pageContext.request.contextPath}/views/template/assets/images/banner/Home_Banner_Web.jpg" alt="banner1">
    </div>
    <div>
      <img class="w-100" src="${pageContext.request.contextPath}/views/template/assets/images/banner/Home_banner_web_2.jpg" alt="banner2">
    </div>
  </div>
...
<main style="margin-top: 75px;">
  <div class="container-fuild trang_chu">
            ...
            <div id="imageSlider" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="${pageContext.request.contextPath}/views/template/assets/images/he_thong_cua_hang/nha_phan_phoi_1.jpg" class="d-block w-100" alt="Slide 1" style="height: 550px;">
                </div>
                <div class="carousel-item">
                  <img src="${pageContext.request.contextPath}/views/template/assets/images/he_thong_cua_hang/nha_phan_phoi_2.jpg" class="d-block w-100" alt="Slide 2" style="height: 550px;">
                </div>
                <div class="carousel-item">
                  <img src="${pageContext.request.contextPath}/views/template/assets/images/he_thong_cua_hang/nha_phan_phoi_3.jpg" class="d-block w-100" alt="Slide 3" style="height: 550px;">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="home-sp">
      <div class="home-img">
        <img src="${pageContext.request.contextPath}/views/template/assets/images/background/product-main-bg.jpg" alt="" width="100%" height="100%" style="filter: brightness(70%) blur(1px); object-fit: cover;">
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="mb-5">
              <div class="tu-van-number">
                <img src="${pageContext.request.contextPath}/views/template/assets/images/represent-images/chicken.jpg" alt="" height="250px" width="100%">
              </div>
              <div class="h5 mt-2 text-center">Chuyên đề gà</div>
            </div>
            <div class="mb-5">
              <div class="tu-van-number">
                <img src="${pageContext.request.contextPath}/views/template/assets/images/represent-images/duck.jpg" alt="" height="250px" width="100%">
              </div>
              <div class="h5 mt-2 text-center">Chuyên đề vịt</div>
            </div>
            <div class="mb-5">
              <div class="tu-van-number">
                <img src="${pageContext.request.contextPath}/views/template/assets/images/represent-images/cow.jpg" alt="" height="250px" width="100%">
              </div>
          ...
          <div class="col-md-6">
            ...
            <div style="margin-top: 120px;">
              <div style="max-width: 636px;
                ...
                <img src="${pageContext.request.contextPath}/views/template/assets/images/represent-images/pig.jpg" alt="" height="500px" width="100%">
              </div>
          ...
          <div class="col-md-3">
            <div class="mb-5">
              <div class="tu-van-number">
                <img src="${pageContext.request.contextPath}/views/template/assets/images/represent-images/shrimp.png" alt="" height="250px" width="100%">
              </div>
              <div class="h5 mt-2 text-center">Chuyên đề tôm</div>
            </div>
            <div class="mb-5">
              <div class="tu-van-number">
                <img src="${pageContext.request.contextPath}/views/template/assets/images/represent-images/fish.jpg" alt="" height="250px" width="100%">
              </div>
              <div class="h5 mt-2 text-center">Chuyên đề cá</div>
            </div>
            <div class="mb-5">
              <div class="tu-van-number">
                <img src="${pageContext.request.contextPath}/views/template/assets/images/represent-images/goat.png" alt="" height="250px" width="100%">
              </div>
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <div class="row">
                <div class="col-md-4">
                  <div class="card">
                    <img src="${pageContext.request.contextPath}/views/template/assets/images/news/news2.jpg" class="card-img-top" alt="Image 1" width="412px" height="276px">
                    <div class="card-body">
                ...
                <div class="col-md-4">
                  <div class="card">
                    <img src="${pageContext.request.contextPath}/views/template/assets/images/news/news1.jpg" class="card-img-top" alt="Image 2" width="412px" height="276px">
                    <div class="card-body">
                ...
                <div class="col-md-4">
                  <div class="card">
                    <img src="${pageContext.request.contextPath}/views/template/assets/images/news/news3.jpg" class="card-img-top" alt="Image 3" width="412px" height="276px">
                    <div class="card-body">
            ...
            <div class="carousel-item">
              <div class="row">
                <div class="col-md-4">
                  <div class="card">
                    <img src="${pageContext.request.contextPath}/views/template/assets/images/news/new7.jpg" class="card-img-top" alt="Image 4" width="412px" height="276px">
                    <div class="card-body">
    ...
    <div class="container-fuild pb-5 mb-5">
      <div class="container text-center">
        ...
        <div class="align-content-center">
          <img src="${pageContext.request.contextPath}/views/template/assets/images/gioi_thieu/vuong_quoc_te.jpg" alt="" class="bg-light">
        </div>
      </div>
    </div>
  </div>
